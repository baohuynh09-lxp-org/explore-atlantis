...
module kafka {
  ...
  cluster_name             = var.internal_input.kafka_cluster_name_customized != "" ? var.internal_input.kafka_cluster_name_customized : "${var.global_input.customer}-${var.global_input.env}-kafka"
